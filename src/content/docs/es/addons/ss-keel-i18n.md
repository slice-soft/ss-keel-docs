...
Este addon está en desarrollo. La interfaz que implementa ya es estable. Ver [Translator](/reference/interfaces#translator).
:::
...
**Implementa:** [`Translator`](/reference/interfaces#translator)
