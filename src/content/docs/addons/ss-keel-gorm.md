...
`ss-keel-gorm` provides a generic `Repository[T, ID]` implementation backed by [GORM](https://gorm.io/). Supports PostgreSQL, MySQL, and SQLite with zero boilerplate for standard CRUD operations.
