...
See [Pagination](/en/reference/pagination) for the full reference.
...
The translator is configured in the app with `app.SetTranslator(t)`. See [Contracts — Translator](/en/reference/interfaces#translator).
