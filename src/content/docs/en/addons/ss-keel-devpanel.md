...
Open `http://localhost:3000/keel/panel` in your browser once the server is running.
...
|-----------|--------|---------------|------------------------------------------------|
| `Enabled` | bool   | `false`       | Enable the panel. Always `false` in production.|
