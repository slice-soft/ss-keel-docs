...
:::caution[Coming Soon]
This addon is under development. The interface it implements is already stable. See [Storage](/en/reference/interfaces#storage).
:::
...
**Implements:** [`Storage`](/en/reference/interfaces#storage)
