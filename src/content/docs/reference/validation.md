---
title: Validation
description: Struct validation using go-playground/validator — field errors and supported tags.
---

The `validation` package wraps [go-playground/validator](https://github.com/go-playground/validator) and produces user-friendly field error messages.
...
For a full list of available validator tags, see the [go-playground/validator documentation](https://pkg.go.dev/github.com/go-playground/validator/v10).
